...
public class PersoonTest {
    ...
    public void testBudgetKoopGameNieuwVoldoendeBudget(){
        boolean gelukt = koper.koop(game1);
        assertEquals(150.0, Math.round(koper.getBudget() * 100)/100d,
                "koop() levert niet het goede budget op.");
    }
    ...
    public void testBudgetKoopGameNieuwOnvoldoendeBudget(){
        boolean gelukt = koperArm.koop(game1);
        assertEquals(36.0, Math.round(koperArm.getBudget() * 100)/100d,
                "koop() levert niet het goede budget op.");
    }
    ...
    public void testResultKoopDubbeleGameVoldoendeBudget(){
        ...
        assertEquals(false, gelukt,
                "Game is al in bezit, maar koop() geeft ten onrechte terug dat de koop gelukt is.");
    }
    ...
    public void testBudgetKoopDubbeleGameVoldoendeBudget(){
        ...
        gelukt = koper.koop(game1);
        assertEquals(150.0,
                Math.round(koper.getBudget() * 100)/100d,
                "koop() levert niet het goede budget op (game is al in bezit)");
    }
    ...
    public void testGameListKoopDubbeleGameVoldoendeBudget(){
        ...
        gelukt = koper.koop(game1);
        assertEquals(toStringTekstKoperHeeftGame1 + "\n" + toStringTekstGame1, koper.toString(),
                "koop() mag niet gelukt zijn (game is al in bezit)," +
                        " maar levert een fout op in, waarschijnlijk, de lijst met Games.");
    }
    ...
    public void testResultKoopDubbeleGameOnvoldoendeBudget(){
        ...
        assertEquals(false, gelukt,
                "Game is al in bezit en er is te weinig budget, " +
                        "maar koop() geeft ten onrechte terug dat de koop gelukt is.");
    }
    ...
    public void testBudgetKoopDubbeleGameOnvoldoendeBudget(){
        ...
        gelukt = koperArm.koop(game2);
        assertEquals(1.00,
                Math.round(koperArm.getBudget() * 100)/100d,
                "koop() levert niet het goede budget op (game is al in bezit).");
    }
    ...
    public void testBudgetVerkoopGeenBezitVerkoper(){
        boolean gelukt = verkoper.verkoop(game1, koper);
        assertEquals(60,
                Math.round(verkoper.getBudget() * 100)/100d,
                "verkoop() levert niet het goede budget van de verkoper op (Game is niet in bezit verkoper).");
        assertEquals(200,
                Math.round(koper.getBudget() * 100)/100d,
                "verkoop() levert niet het goede budget van de koper op (Game is niet in bezit verkoper).");
    }
    ...
    public void testGameListVerkoopGeenBezitVerkoper(){
        ...
        assertEquals(toStringTekstVerkoper0Games, verkoper.toString(),
                "verkoop() mag niet gelukt zijn (Game is niet in bezit verkoper), " +
                        "maar levert een fout op in, waarschijnlijk, de lijst met Games (verkoper).");
        assertEquals(toStringTekstKoper0Games, koper.toString(),
                "verkoop() mag niet gelukt zijn (Game is niet in bezit verkoper), " +
                        "maar levert een fout op in, waarschijnlijk, de lijst met Games (koper).");
    }
    ...
    public void testBudgetVerkoopKoperOnvoldoendeBudget(){
        ...
        assertEquals(10,
                Math.round(verkoper.getBudget() * 100)/100d,
                "verkoop() levert niet het goede budget van de verkoper op (game is niet verkocht).");
        assertEquals(36,
                Math.round(koperArm.getBudget() * 100)/100d,
                "verkoop() levert niet het goede budget van de koper op (game is niet verkocht).");
    }
    ...
    public void testGameListVerkoopKoperOnvoldoendeBudget(){
        ...
        assertEquals(toStringTekstVerkoperHeeftGame1 + "\n" + toStringTekstGame1, verkoper.toString(),
                "verkoop() mag niet gelukt zijn (koper onvoldoende budget), " +
                        "maar levert een fout op in, waarschijnlijk, de lijst met Games (verkoper).");
        assertEquals(toStringTekstKoper0Games, koper.toString(),
                "verkoop() mag niet gelukt zijn (koper onvoldoende budget), " +
                        "maar levert een fout op in, waarschijnlijk, de lijst met Games (koper).");
    ...
    public void testGameListVerkoopKoperDubbeleGame(){
        ...
        assertEquals(toStringTekstVerkoperHeeftGame2 + "\n" + toStringTekstGame2, verkoper.toString(),
                "verkoop() mag niet gelukt zijn (koper heeft game al), " +
                        "maar levert een fout op in, waarschijnlijk, de lijst met Games (verkoper).");
    ...
    public void testBudgetVerkoopVoorwaardenOK(){
        ...
        assertEquals(60,
                Math.round(verkoper.getBudget() * 100)/100d,
                "verkoop() levert niet het goede budget van de verkoper op (game is verkocht).");
        assertEquals(165,
                Math.round(koper.getBudget() * 100)/100d,
                "verkoop() levert niet het goede budget van de koper op (game is verkocht).");
    }
