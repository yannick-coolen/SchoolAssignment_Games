...
public class GameTest {
    ...
    public void testHuidigeWaardeNwPrijsNa0Jr(){
        ...
        assertEquals(50.0,
                Math.round(game0JrOud.huidigeWaarde() * 100)/100d,
                "Huidige waarde na 0 jr niet correct.");
    }

    @Test
    public void testHuidigeWaardeNwPrijsNa1Jr(){
        assertEquals(35.0,
                Math.round(game1JrOud.huidigeWaarde() * 100)/100d,
                "Huidige waarde na 1 jr niet correct.");
    }
    ...
    public void testHuidigeWaardeNwPrijsNa5Jr(){
        ...
        assertEquals(8.4,
                Math.round(game5JrOud.huidigeWaarde() * 100)/100d,
                "Huidige waarde na 5 jr niet correct.");
    }
    ...
    public void testHuidigeWaardeGratisGameNa0Jr(){
        ...
        assertEquals(0.0,
                Math.round(gratisGame0JrOud.huidigeWaarde() * 100)/100d,
                "Huidige waarde gratis game na 0 jr niet correct.");
    }
    ...
    public void testHuidigeWaardeGratisGameNa5Jr(){
        ...
        assertEquals(0.0,
                Math.round(gratisGame5JrOud.huidigeWaarde() * 100)/100d,
                "Huidige waarde gratis game na 5 jr niet correct.");
    }
    ...
    public void testGameNotEqualsGameAndereNaam() {
        ...
        assertFalse(game1JrOud.equals(otherGame1JrOud),
                "equals() geeft true bij vgl. met game met andere naam");
    }

    @Test
    public void testGameNotEqualsGameAnderJaar() {
        Game game5JrOud = new Game("Mario Kart", ditJaar-5, 50.0);
        assertFalse(game1JrOud.equals(game5JrOud),
                "equals() geeft true bij vgl. met game met ander releaseJaar");
    }

    @Test
    public void testGameEqualsGameAndereNwPrijs() {
        Game duurdereGame1JrOud = new Game("Mario Kart", ditJaar-1, 59.95);
        assertTrue(game1JrOud.equals(duurdereGame1JrOud),
                "equals() geeft false bij vgl. met zelfde game met andere nieuwprijs");
    }
